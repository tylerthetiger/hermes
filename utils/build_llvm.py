...
def parse_args():
    ...
    parser.add_argument("llvm_src_dir", type=str)
    parser.add_argument("llvm_build_dir", type=str)
    parser.add_argument(
        "--target-platform",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        dest="build_system",
        choices=["Ninja", "Unix Makefiles", "Visual Studio 15 2017 Win64"],
        default="Ninja",
    ...
    if not args.build_command:
        ...
        elif args.build_system == "Visual Studio 15 2017 Win64":
            args.build_command = (
